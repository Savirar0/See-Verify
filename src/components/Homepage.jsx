            ...
            case "template6":{
                return (
                    <div style={{ position: 'relative', border: '1px solid gray'  }} id="template2">
                        ...
                        <div className="info" style={{ position: 'absolute', top: '45%', width: '100%' ,display:'flex',flexDirection:'column',alignItems:'center'}}>
    ...
    return (props.trigger) ? (
        <div className="popup">
            <div className="popup-box">
                ...
                <h3 style={{fontWeight: '100'}}>1. Rules for Certificate Generation</h3>
                <div className="content">
                    <li>Choose Any Template</li>
                    <li>Provide Certificate Data</li>
                    <li>Then Download</li>
                </div>
                <h3 style={{fontWeight: '100', marginTop: '10px'}}>2. Rules for NFT Minting</h3>
                <div className="content">
                    <li>Download E-Certificate</li>
                    <li>Locate and tap on the "NFT Mint" button</li>
                    <li>Will be redirected to NFT Section</li>
                    <li>Thank You!</li>
                </div>
            </div>
        </div>
    ...
    return (
        <div className="main" style={{background: (theme == "dark")?"rgb(28, 39, 43)":"white"}}>
            ...
            <div className="header">
                <div className="left">
                    <h2 style={{color: (theme == "dark")?"white":"rgb(28, 39, 43)"}}>Seeverify</h2>
                    <button id="toggler" onClick={()=>toggleTheme()}>{theme == 'light'?"Dark Mode":"Light Mode"}</button>
                </div>
                
                <div className="right">
                    <button className="info" onClick={() => setpop(true)}>i</button>
                    <a href="/blockchain/backend1.html">NFT Mint 🔗</a>
                    <a href="/blockchain/backend2.html">Verifier</a>
                </div>
            </div>
            <div className="maincontainer">
                <div className="leftmost">
                    <h1 style={{color: (theme == "dark")?"white":"rgb(28, 39, 43)"}}>Choose Design</h1>
